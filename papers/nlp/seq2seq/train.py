...
if __name__ == '__main__':
    ...
    print(f"Data loaded, {len(en_data)} sentences, from {len(en_vocab)} vocab to {len(fi_vocab)} vocab")
    ...
    translation = translate_sentence(test_sentence, en_vocab, fi_vocab, encoder, decoder)
